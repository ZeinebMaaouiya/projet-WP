...
if ( ! function_exists( 'aether_unregister_patterns' ) ) :
	/**
	 * Unregister Jetpack patterns and core patterns bundled in WordPress.
	 */
	function aether_unregister_patterns() {
		$pattern_names = array(
...
if ( ! function_exists( 'aether_setup' ) ) :
	/**
...
if ( ! function_exists( 'aether_styles' ) ) :
	/**
	 * Enqueue styles.
	 *
	 * @since Assembler 1.0
	...
	function aether_styles() {
		...
		wp_enqueue_style( 'aether-style' );

	}

endif;

add_action( 'wp_enqueue_scripts', 'aether_styles' );
